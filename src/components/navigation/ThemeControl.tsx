...
export const ThemeControl: React.FC<ThemeControlProps> = ({
  ...
  return (
    <button
      ...
      className={cn(
        'relative inline-flex items-center justify-center w-9 h-9 rounded-sm transition-colors duration-150 cursor-pointer select-none focus-visible:outline-2 focus-visible:outline-accent',
